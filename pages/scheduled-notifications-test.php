...
if (isset($_POST['save_template']) && isset($_POST['template_content']) && isset($_POST['template_file'])) {
    ...
    $allowed_templates = [
        'task_notification.php' => __DIR__ . '/../emails/templates/task_notification.php',
        'habit_notification.php' => __DIR__ . '/../emails/templates/habit_notification.php',
        'morning_briefing.php' => __DIR__ . '/../emails/templates/morning_briefing.php'
    ];
    ...
    try {
        switch ($notification_type) {
            ...
            case 'habit':
                ...
                $output = shell_exec('php ' . __DIR__ . '/../emails/cron/habit_notifications.php 2>&1');
                $notification_sent = true;
                break;
            case 'morning':
                // Execute the morning briefing script
                $output = shell_exec('php ' . __DIR__ . '/../emails/cron/morning_briefing.php 2>&1');
                $notification_sent = true;
                break;
            default:
